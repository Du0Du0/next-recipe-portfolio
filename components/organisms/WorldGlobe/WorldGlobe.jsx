...
function WorldGlobe() {
	...
	return (
		<>
			<div id={styles.stars} /> <div id={styles.stars2} /> <div id={styles.stars3} />
			<main className={clsx(styles.worldGlobe)}>
				<Title type={'logo'} style={{ color: '#cacaca' }}>
					Discover Our Global Network of IKEA Stores
				</Title>
				<Text type={'desc'}>
				...
				<div className='buttonWrap'>
					<Btn className={clsx(styles.btn)} onClick={startRotation}>
						Rotate
					</Btn>
					<Btn className={clsx(styles.btn)} onClick={stopRotation}>
						Stop
					</Btn>
				</div>
				...
				<div className='worldGlobe' onMouseMove={handleMouseMove} style={{ position: 'relative', overflow: 'visible' }}>
					{selectedCountryIndex && (
						<aside className='previewCountryName'>
							<Title type={'logo'} url={`/find-recipe/${HoveredCountry}?name=${HoveredCountry}`}>
								{HoveredCountry} . . .
							</Title>
						</aside>
					)}
